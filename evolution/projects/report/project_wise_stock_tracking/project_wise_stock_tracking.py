...
def get_columns():
	return [_("Work Order No") + ":Link/Project:140", _("Cost of Purchased Items") + ":Currency:160",
		_("Cost of Issued Items") + ":Currency:160", _("Cost of Delivered Items") + ":Currency:160",
		_("Work Order Name") + "::120", _("Project Status") + "::120", _("Company") + ":Link/Company:100",
		_("Customer") + ":Link/Customer:140", _("Work Order Value") + ":Currency:120",
		_("Work Order Start Date") + ":Date:120", _("Completion Date") + ":Date:120"]
